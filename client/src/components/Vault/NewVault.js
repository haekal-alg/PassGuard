...
function NewVault() {
	...
	async function editLogin(item) {
		if ( newLoginName.current.value !== "" && newUsername.current.value !== "" && newPassword.current.value !== "" ) {
			console.log(newLoginName.current.value, newUsername.current.value, newPassword.current.value);
			...
			console.log(encryptedNewLoginName, encryptedNewLoginPassword, encryptedNewLoginPassword);
			console.log(newLoginName.current.value, newUsername.current.value, newPassword.current.value);
										...
										<form className="add-details">
											...
											<div className="button">
												...
												<input
													...
													value="Edit Vault"
													className="add-btn"
													onClick={() => editLogin(authCtx.vault.loginData[indexEditLogin])}
												/>
											</div>
										</form>
										<img
								...
								{!isEditNote && (
									<>
										<form className="add-details">
											...
											<div className="input-holder">
												<SpeakerNotesIcon sx={{ color: grey[600] }} fontSize="20px" className="input-image"/>
												<input
													type="text"
													className="input-element"
											...
											<div className="input-holder-note">
												<CommentIcon sx={{ color: grey[600] }} fontSize="20px" className="input-image"/>
												<textarea
